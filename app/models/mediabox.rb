class Mediabox < ActiveRecord::Base
  ...
  config_my_admin do |admin|
    ...
    admin.list_display = [:id, :title, :subtitle, :position, :image]
    admin.fieldsets = [{:fields => [:title, :subtitle, :position, :image, :seo_title, :seo_description, :seo_keywords]}]
