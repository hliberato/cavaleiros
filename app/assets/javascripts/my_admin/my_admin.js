...
$(document).on('ready page:load', function(){
  ...
  $(".add_new_has_many_item").click(function(e){
      ...
      clone.find('img').attr( "src", "/assets/my_admin/no_image-32da62bd576787028ee8469468d66fe6e93bdfd8cd0c14aba42296b43fd92f2b.gif" );
      clone.find('.fileupload-new.thumbnail').attr( "style", "max-width: 200px;max-height: 150px;line-height: 0px!important;" );
